...
// This is so that a static set of pmenu entries can be used for multiple clients and changed without interference
...
pmenuhnd_t *PMenu_Open(edict_t *ent, pmenu_t *entries, int cur, int num, void *arg)
{
	...
	pmenuhnd_t *hnd = gi.TagMalloc(sizeof(*hnd), TAG_LEVEL);
