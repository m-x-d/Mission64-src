...
extern int BoxOnPlaneSide2 ( const vec3_t emins , const vec3_t emaxs , struct cplane_s * p ) ;
...
extern void Blaster_Fire ( edict_t * ent , const vec3_t g_offset , int damage , qboolean hyper , int effect , int color ) ;
...
extern void cock_offhand_grenade ( edict_t * ent ) ;
extern void throw_offhand_grenade ( edict_t * ent ) ;
extern void Weapon_Generic ( edict_t * ent , int FRAME_ACTIVATE_LAST , int FRAME_FIRE_LAST , int FRAME_IDLE_LAST , int FRAME_DEACTIVATE_LAST , int FRAME_SELECT_SOUND , char * PICKUP_SOUND , int * pause_frames , int * fire_frames , void ( * fire ) ( edict_t * ent2 , qboolean altfire ) ) ;
extern void Weapon_Generic2 ( edict_t * ent , int FRAME_ACTIVATE_LAST , int FRAME_FIRE_LAST , int FRAME_IDLE_LAST , int FRAME_DEACTIVATE_LAST , int FRAME_SELECT_SOUND , char * PICKUP_SOUND , int * pause_frames , int * fire_frames , void ( * fire ) ( edict_t * ent2 , qboolean altfire ) ) ;
extern void eject_shotgun_shell ( edict_t * ent , vec3_t offset ) ;
extern void eject_bullet_shell ( edict_t * ent , vec3_t offset ) ;
...
extern void PlayerNoise ( edict_t * who , const vec3_t where , int type ) ;
extern void P_ProjectSource2 ( gclient_t * client , vec3_t point , const vec3_t distance , vec3_t forward , vec3_t right , vec3_t up , vec3_t result ) ;
extern void P_ProjectSource ( gclient_t * client , vec3_t point , const vec3_t distance , vec3_t forward , vec3_t right , vec3_t result ) ;
...
extern float SV_CalcRoll ( vec3_t angles , const vec3_t velocity ) ;
...
extern void PlayerTrail_Add ( const vec3_t spot ) ;
...
extern void tank_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern void soldier_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern qboolean parasite_drain_attack_ok ( const vec3_t start , const vec3_t end ) ;
...
extern void parasite_step ( edict_t * self ) ;
...
extern qboolean is_headless ( edict_t * self ) ;
extern void infantry_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern void infantry_bleed ( edict_t * self ) ;
...
extern void hover_dead_spin ( edict_t * self ) ;
extern void hover_dead_touch ( edict_t * self , edict_t * other , cplane_t * p , csurface_t * s ) ;
extern void vector_rotate_xy ( vec3_t v , float theta ) ;
extern void hover_deadthink ( edict_t * self ) ;
extern void hover_spawn_gibs ( edict_t * self , int damage ) ;
...
extern void fake_flyer_sparks ( edict_t * self ) ;
...
extern void chick_misfire ( edict_t * self ) ;
extern void chick_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern qboolean AimGrenade ( edict_t * self , vec3_t start , const vec3_t target , vec_t speed , vec3_t aim ) ;
...
extern qboolean point_infront ( edict_t * self , const vec3_t point ) ;
...
extern void trigger_relay_autotrigger ( edict_t * self ) ;
...
extern void ThrowRock ( edict_t * self , char * modelname , float speed , const vec3_t origin , const vec3_t size , int mass ) ;
...
extern void target_anger_autotrigger ( edict_t * self ) ;
...
extern void ReflectSparks ( int type , const vec3_t origin , const vec3_t movedir ) ;
extern void ReflectSteam ( const vec3_t origin , const vec3_t movedir , int count , int sounds , int speed , int wait , int nextid ) ;
extern void ReflectTrail ( int type , const vec3_t start , const vec3_t end ) ;
extern void ReflectExplosion ( int type , const vec3_t origin ) ;
extern qboolean WithinBBox ( vec3_t p , edict_t * mirror ) ;
extern void G_RunEntity ( edict_t * ent ) ;
extern void SV_Physics_Conveyor ( edict_t * ent ) ;
extern void SV_Physics_Debris ( edict_t * ent ) ;
extern trace_t SV_DebrisEntity ( edict_t * ent , const vec3_t push ) ;
...
extern trace_t SV_PushEntity ( edict_t * ent , const vec3_t push ) ;
...
extern int ClipVelocity ( const vec3_t in , const vec3_t normal , vec3_t out , float overbounce ) ;
...
extern void M_SpawnEffect ( edict_t * self , int effect , vec3_t localpos , vec3_t localnormal ) ;
extern void NormalToWorld ( edict_t * self , vec3_t localnormal , vec3_t result ) ;
extern void PositionToWorld ( edict_t * self , vec3_t localpos , vec3_t result ) ;
...
extern void monster_eject_shotgun_shell ( edict_t * ent , vec3_t offset ) ;
extern void monster_eject_bullet_shell ( edict_t * ent , vec3_t offset ) ;
...
extern void PrecacheDebrisType ( char * model , int count ) ;
...
extern void spawn_precipitation ( edict_t * self , const vec3_t org , vec3_t dir , float speed ) ;
...
extern void SP_misc_halo ( edict_t * ent ) ;
extern void misc_halo_think ( edict_t * self ) ;
...
extern void ThrowDebris ( edict_t * self , char * modelname , float speed , const vec3_t origin , int skin , int effects ) ;
...
extern edict_t * ThrowGibEx ( edict_t * self , char * gibname , int damage , int type , const vec3_t position , vec3_t direction , const vec3_t velocity_scale , const vec3_t angular_velocity_scale ) ;
extern edict_t * ThrowGib ( edict_t * self , char * gibname , int damage , int type ) ;
...
extern void AlignToPlane ( edict_t * self , cplane_t * plane , int extraroll ) ;
extern void VelocityForDamageDirectional ( int damage , vec3_t dir , vec3_t v ) ;
...
extern qboolean box_movestep ( edict_t * ent , const vec3_t move , qboolean relink ) ;
...
extern float GetAngularVelocity ( float velocity , float angle , float idealangle ) ;
...
extern void movewith_init ( edict_t * self ) ;
...
extern void Move_Calc ( edict_t * ent , const vec3_t dest , void ( * func ) ( edict_t * ) ) ;
extern void Move_Begin ( edict_t * ent ) ;
extern void Move_Final ( edict_t * ent ) ;
extern void Move_Done ( edict_t * ent ) ;
extern void check_reverse_rotation ( edict_t * self , const vec3_t point ) ;
...
extern void CTFVote ( edict_t * ent , qboolean yes ) ;
...
extern void CTFGrappleFire ( edict_t * ent , const vec3_t g_offset , int damage , int effect ) ;
extern void CTFFireGrapple ( edict_t * self , const vec3_t start , vec3_t dir , int damage , int speed , int effect ) ;
...
extern void loc_buildboxpoints ( vec3_t p [ 8 ] , const vec3_t org , const vec3_t mins , const vec3_t maxs ) ;
...
extern void SpawnSpeaker ( edict_t * self ) ;
extern void SP_crane_control ( edict_t * self ) ;
extern void Use_Crane_Control ( edict_t * ent , edict_t * other , edict_t * activator ) ;
extern void crane_control_action ( edict_t * control , edict_t * activator , const vec3_t point ) ;
