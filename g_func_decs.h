...
extern edict_t * ThrowGibEx ( edict_t * self , char * gibname , int damage , int type , vec3_t position , vec3_t direction , vec3_t velocity_scale , vec3_t angular_velocity_scale ) ;
